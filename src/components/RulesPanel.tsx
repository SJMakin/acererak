  ...
  return (
    ...
    >
      ...
      >
        ...
        <p>
          On a natural 20, the player rolls damage dice twice and adds modifiers
          once.
        </p>
      ...
      >
        ...
        <p>
          During a long rest, characters regain all hit points and half of their
          spent Hit Dice.
        </p>
      </div>
      ...
      >
        ...
        <p>
          Identifying a magic item requires a short rest and a successful Arcana
          check (DC 15).
        </p>
      </div>
    </div>
