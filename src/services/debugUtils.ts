 ...
 */
export function setDebugMode(mode: DebugMode | DebugMode[], enable: boolean): void {
  ...
  console.log(`Debug mode ${enable ? 'enabled' : 'disabled'} for: ${modes.join(', ')}`);
}
...
export function initDebugUtils(): void {
  if (typeof window !== 'undefined') {
    ...
    console.log('Debug utilities initialized. Use window.debugUtils.enableDebug() to enable debug mode.');
  }
}
